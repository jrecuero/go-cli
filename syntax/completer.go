...
func NewCompleter(label string, content IContent) *Completer {
	c := &Completer{
		Label:   label,
		Content: content,
	}
...
func NewIdentCompleter(label string, content IContent) *Ident {
	i := &Ident{
		&Completer{
			Label:   label,
			Content: content,
...
//func (i *Ident) Query(ctx *Context, line interface{}) (interface{}, bool) {
//    return nil, false
//}
...
func NewAnyCompleter(label string, content IContent) *Any {
	a := &Any{
		&Completer{
			Label:   label,
			Content: content,
...
//// Query returns the query for any node completer.
//func (a *Any) Query(ctx *Context, line interface{}) (interface{}, bool) {
//    return nil, false
//}
...
func NewCustomCompleter(label string, content IContent) *Custom {
	c := &Custom{
		&Completer{
			Label:   label,
			Content: content,
...
//// Query returns the query for Custom node completer.
//func (c *Custom) Query(ctx *Context, line interface{}) (interface{}, bool) {
//    return nil, false
//}
...
//func (j *Joint) Query(ctx *Context, line interface{}) (interface{}, bool) {
//    return nil, false
//}
